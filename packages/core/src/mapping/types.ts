export type ImportKind = 'ORDERS' | 'OFFERS' | 'OUTCOMES' | 'DECISIONS';

export type MappingConfidence = 'HIGH' | 'MEDIUM' | 'NEEDS_REVIEW' | 'UNMAPPED';
...
export const CANONICAL_FIELD_METADATA: Record<
  ImportKind,
